...
session_start();
  ...
  $result=mysqli_query($con,"select b.carId,c.carName,b.bookingDate,b.purchaseDate,b.returnDate,b.amount,u.userId,u.userName from booking b inner join car_info c on b.carId=c.carId inner join user_info u on u.userId = b.userId");
